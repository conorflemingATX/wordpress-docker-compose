...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = SASSICO_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( SASSICO_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'sassico' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'sassico' ),
					'hand'				 => esc_html__( 'Hand Icons', 'sassico' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'sassico' ),
					'gender'			 => esc_html__( 'Gender Icons', 'sassico' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'sassico' ),
					'payment'			 => esc_html__( 'Payment Icons', 'sassico' ),
					'currency'			 => esc_html__( 'Currency Icons', 'sassico' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'sassico' ),
					'directional'		 => esc_html__( 'Directional Icons', 'sassico' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'sassico' ),
					'brand'				 => esc_html__( 'Brand Icons', 'sassico' ),
					'medical'			 => esc_html__( 'Medical Icons', 'sassico' ),
					'sassico-icons'	 => esc_html__( 'Sassico Icons', 'sassico' ),
				),
				'icons'				 => array(
					...
					'icon icon-strategicservices_icon1' => array('group' => 'sassico-icons'),
					'icon icon-strategicservices_icon3' => array('group' => 'sassico-icons'),
					'icon icon-strategicservices_icon4' => array('group' => 'sassico-icons'),
					'icon icon-strategicservices_icon5' => array('group' => 'sassico-icons'),
					'icon icon-strategicservices_icon6' => array('group' => 'sassico-icons'),
					'icon icon-strategicservices_icon7' => array('group' => 'sassico-icons'),
					'icon icon-strategicservices_icon8' => array('group' => 'sassico-icons'),
					'icon icon-post_icon1' => array('group' => 'sassico-icons'),
					'icon icon-post_icon2' => array('group' => 'sassico-icons'),
					'icon icon-post_icon3' => array('group' => 'sassico-icons'),
					'icon icon-post_icon4' => array('group' => 'sassico-icons'),
					'icon icon-post_icon5' => array('group' => 'sassico-icons'),
					'icon icon-application_icon' => array('group' => 'sassico-icons'),
					'icon icon-opened_positions_icon1' => array('group' => 'sassico-icons'),
					'icon icon-opened_positions_icon2' => array('group' => 'sassico-icons'),
					'icon icon-about_us_icon1' => array('group' => 'sassico-icons'),
					'icon icon-about_us_icon2' => array('group' => 'sassico-icons'),
					'icon icon-about_us_icon3' => array('group' => 'sassico-icons'),
					'icon icon-about_us_icon4' => array('group' => 'sassico-icons'),
					'icon icon-About-2' => array('group' => 'sassico-icons'),
					'icon icon-About-3' => array('group' => 'sassico-icons'),
					'icon icon-About-4' => array('group' => 'sassico-icons'),
					'icon icon-About' => array('group' => 'sassico-icons'),
					'icon icon-Banner_current' => array('group' => 'sassico-icons'),
					'icon icon-Banner_factory-1' => array('group' => 'sassico-icons'),
					'icon icon-Banner_factory' => array('group' => 'sassico-icons'),
					'icon icon-Banner_pumpjack' => array('group' => 'sassico-icons'),
					'icon icon-Funfacts-2' => array('group' => 'sassico-icons'),
					'icon icon-Funfacts-3' => array('group' => 'sassico-icons'),
					'icon icon-Funfacts-4' => array('group' => 'sassico-icons'),
					'icon icon-Funfacts' => array('group' => 'sassico-icons'),
					'icon icon-mobile' => array('group' => 'sassico-icons'),
					'icon icon-laptop' => array('group' => 'sassico-icons'),
					'icon icon-desktop' => array('group' => 'sassico-icons'),
					'icon icon-tablet' => array('group' => 'sassico-icons'),
					'icon icon-phone' => array('group' => 'sassico-icons'),
					'icon icon-document' => array('group' => 'sassico-icons'),
					'icon icon-documents' => array('group' => 'sassico-icons'),
					'icon icon-search' => array('group' => 'sassico-icons'),
					'icon icon-clipboard' => array('group' => 'sassico-icons'),
					'icon icon-newspaper' => array('group' => 'sassico-icons'),
					'icon icon-notebook' => array('group' => 'sassico-icons'),
					'icon icon-book-open' => array('group' => 'sassico-icons'),
					'icon icon-browser' => array('group' => 'sassico-icons'),
					'icon icon-calendar' => array('group' => 'sassico-icons'),
					'icon icon-presentation' => array('group' => 'sassico-icons'),
					'icon icon-picture' => array('group' => 'sassico-icons'),
					'icon icon-pictures' => array('group' => 'sassico-icons'),
					'icon icon-video' => array('group' => 'sassico-icons'),
					'icon icon-camera' => array('group' => 'sassico-icons'),
					'icon icon-printer' => array('group' => 'sassico-icons'),
					'icon icon-toolbox' => array('group' => 'sassico-icons'),
					'icon icon-briefcase' => array('group' => 'sassico-icons'),
					'icon icon-wallet' => array('group' => 'sassico-icons'),
					'icon icon-gift' => array('group' => 'sassico-icons'),
					'icon icon-bargraph' => array('group' => 'sassico-icons'),
					'icon icon-grid' => array('group' => 'sassico-icons'),
					'icon icon-expand' => array('group' => 'sassico-icons'),
					'icon icon-focus' => array('group' => 'sassico-icons'),
					'icon icon-edit' => array('group' => 'sassico-icons'),
					'icon icon-adjustments' => array('group' => 'sassico-icons'),
					'icon icon-ribbon' => array('group' => 'sassico-icons'),
					'icon icon-hourglass' => array('group' => 'sassico-icons'),
					'icon icon-lock' => array('group' => 'sassico-icons'),
					'icon icon-megaphone' => array('group' => 'sassico-icons'),
					'icon icon-shield' => array('group' => 'sassico-icons'),
					'icon icon-trophy' => array('group' => 'sassico-icons'),
					'icon icon-flag' => array('group' => 'sassico-icons'),
					'icon icon-map' => array('group' => 'sassico-icons'),
					'icon icon-puzzle' => array('group' => 'sassico-icons'),
					'icon icon-basket' => array('group' => 'sassico-icons'),
					'icon icon-envelope' => array('group' => 'sassico-icons'),
					'icon icon-streetsign' => array('group' => 'sassico-icons'),
					'icon icon-telescope' => array('group' => 'sassico-icons'),
					'icon icon-gears' => array('group' => 'sassico-icons'),
					'icon icon-key' => array('group' => 'sassico-icons'),
					'icon icon-paperclip' => array('group' => 'sassico-icons'),
					'icon icon-attachment' => array('group' => 'sassico-icons'),
					'icon icon-pricetags' => array('group' => 'sassico-icons'),
					'icon icon-lightbulb' => array('group' => 'sassico-icons'),
					'icon icon-layers' => array('group' => 'sassico-icons'),
					'icon icon-pencil' => array('group' => 'sassico-icons'),
					'icon icon-tools' => array('group' => 'sassico-icons'),
					'icon icon-tools-2' => array('group' => 'sassico-icons'),
					'icon icon-scissors' => array('group' => 'sassico-icons'),
					'icon icon-paintbrush' => array('group' => 'sassico-icons'),
					'icon icon-magnifying-glass' => array('group' => 'sassico-icons'),
					'icon icon-circle-compass' => array('group' => 'sassico-icons'),
					'icon icon-linegraph' => array('group' => 'sassico-icons'),
					'icon icon-mic' => array('group' => 'sassico-icons'),
					'icon icon-strategy' => array('group' => 'sassico-icons'),
					'icon icon-beaker' => array('group' => 'sassico-icons'),
					'icon icon-caution' => array('group' => 'sassico-icons'),
					'icon icon-recycle' => array('group' => 'sassico-icons'),
					'icon icon-anchor' => array('group' => 'sassico-icons'),
					'icon icon-profile-male' => array('group' => 'sassico-icons'),
					'icon icon-profile-female' => array('group' => 'sassico-icons'),
					'icon icon-bike' => array('group' => 'sassico-icons'),
					'icon icon-wine' => array('group' => 'sassico-icons'),
					'icon icon-hotairballoon' => array('group' => 'sassico-icons'),
					'icon icon-globe' => array('group' => 'sassico-icons'),
					'icon icon-genius' => array('group' => 'sassico-icons'),
					'icon icon-map-pin' => array('group' => 'sassico-icons'),
					'icon icon-dial' => array('group' => 'sassico-icons'),
					'icon icon-chat' => array('group' => 'sassico-icons'),
					'icon icon-heart' => array('group' => 'sassico-icons'),
					'icon icon-cloud' => array('group' => 'sassico-icons'),
					'icon icon-upload' => array('group' => 'sassico-icons'),
					'icon icon-download' => array('group' => 'sassico-icons'),
					'icon icon-target' => array('group' => 'sassico-icons'),
					'icon icon-hazardous' => array('group' => 'sassico-icons'),
					'icon icon-piechart' => array('group' => 'sassico-icons'),
					'icon icon-speedometer' => array('group' => 'sassico-icons'),
					'icon icon-global' => array('group' => 'sassico-icons'),
					'icon icon-compass' => array('group' => 'sassico-icons'),
					'icon icon-lifesaver' => array('group' => 'sassico-icons'),
					'icon icon-clock' => array('group' => 'sassico-icons'),
					'icon icon-aperture' => array('group' => 'sassico-icons'),
					'icon icon-quote' => array('group' => 'sassico-icons'),
					'icon icon-scope' => array('group' => 'sassico-icons'),
					'icon icon-alarmclock' => array('group' => 'sassico-icons'),
					'icon icon-refresh' => array('group' => 'sassico-icons'),
					'icon icon-happy' => array('group' => 'sassico-icons'),
					'icon icon-sad' => array('group' => 'sassico-icons'),
					'icon icon-facebook' => array('group' => 'sassico-icons'),
					'icon icon-twitter' => array('group' => 'sassico-icons'),
					'icon icon-googleplus' => array('group' => 'sassico-icons'),
					'icon icon-rss' => array('group' => 'sassico-icons'),
					'icon icon-tumblr' => array('group' => 'sassico-icons'),
					'icon icon-linkedin' => array('group' => 'sassico-icons'),
					'icon icon-dribbble' => array('group' => 'sassico-icons'),
					'icon icon-home' => array('group' => 'sassico-icons'),
					'icon icon-apartment' => array('group' => 'sassico-icons'),
					'icon icon-pencil1' => array('group' => 'sassico-icons'),
					'icon icon-magic-wand' => array('group' => 'sassico-icons'),
					'icon icon-drop' => array('group' => 'sassico-icons'),
					'icon icon-lighter' => array('group' => 'sassico-icons'),
					'icon icon-poop' => array('group' => 'sassico-icons'),
					'icon icon-sun' => array('group' => 'sassico-icons'),
					'icon icon-moon' => array('group' => 'sassico-icons'),
					'icon icon-cloud1' => array('group' => 'sassico-icons'),
					'icon icon-cloud-upload' => array('group' => 'sassico-icons'),
					'icon icon-cloud-download' => array('group' => 'sassico-icons'),
					'icon icon-cloud-sync' => array('group' => 'sassico-icons'),
					'icon icon-cloud-check' => array('group' => 'sassico-icons'),
					'icon icon-database' => array('group' => 'sassico-icons'),
					'icon icon-lock1' => array('group' => 'sassico-icons'),
					'icon icon-cog' => array('group' => 'sassico-icons'),
					'icon icon-trash' => array('group' => 'sassico-icons'),
					'icon icon-dice' => array('group' => 'sassico-icons'),
					'icon icon-heart1' => array('group' => 'sassico-icons'),
					'icon icon-star' => array('group' => 'sassico-icons'),
					'icon icon-star-half' => array('group' => 'sassico-icons'),
					'icon icon-star-empty' => array('group' => 'sassico-icons'),
					'icon icon-flag1' => array('group' => 'sassico-icons'),
					'icon icon-envelope1' => array('group' => 'sassico-icons'),
					'icon icon-paperclip1' => array('group' => 'sassico-icons'),
					'icon icon-inbox' => array('group' => 'sassico-icons'),
					'icon icon-eye' => array('group' => 'sassico-icons'),
					'icon icon-printer1' => array('group' => 'sassico-icons'),
					'icon icon-file-empty' => array('group' => 'sassico-icons'),
					'icon icon-file-add' => array('group' => 'sassico-icons'),
					'icon icon-enter' => array('group' => 'sassico-icons'),
					'icon icon-exit' => array('group' => 'sassico-icons'),
					'icon icon-graduation-hat' => array('group' => 'sassico-icons'),
					'icon icon-license' => array('group' => 'sassico-icons'),
					'icon icon-music-note' => array('group' => 'sassico-icons'),
					'icon icon-film-play' => array('group' => 'sassico-icons'),
					'icon icon-camera-video' => array('group' => 'sassico-icons'),
					'icon icon-camera1' => array('group' => 'sassico-icons'),
					'icon icon-picture1' => array('group' => 'sassico-icons'),
					'icon icon-book' => array('group' => 'sassico-icons'),
					'icon icon-bookmark' => array('group' => 'sassico-icons'),
					'icon icon-user' => array('group' => 'sassico-icons'),
					'icon icon-users' => array('group' => 'sassico-icons'),
					'icon icon-shirt' => array('group' => 'sassico-icons'),
					'icon icon-store' => array('group' => 'sassico-icons'),
					'icon icon-cart' => array('group' => 'sassico-icons'),
					'icon icon-tag' => array('group' => 'sassico-icons'),
					'icon icon-phone-handset' => array('group' => 'sassico-icons'),
					'icon icon-phone1' => array('group' => 'sassico-icons'),
					'icon icon-pushpin' => array('group' => 'sassico-icons'),
					'icon icon-map-marker' => array('group' => 'sassico-icons'),
					'icon icon-map1' => array('group' => 'sassico-icons'),
					'icon icon-location' => array('group' => 'sassico-icons'),
					'icon icon-calendar-full' => array('group' => 'sassico-icons'),
					'icon icon-keyboard' => array('group' => 'sassico-icons'),
					'icon icon-spell-check' => array('group' => 'sassico-icons'),
					'icon icon-screen' => array('group' => 'sassico-icons'),
					'icon icon-smartphone' => array('group' => 'sassico-icons'),
					'icon icon-tablet1' => array('group' => 'sassico-icons'),
					'icon icon-laptop1' => array('group' => 'sassico-icons'),
					'icon icon-laptop-phone' => array('group' => 'sassico-icons'),
					'icon icon-power-switch' => array('group' => 'sassico-icons'),
					'icon icon-bubble' => array('group' => 'sassico-icons'),
					'icon icon-heart-pulse' => array('group' => 'sassico-icons'),
					'icon icon-construction' => array('group' => 'sassico-icons'),
					'icon icon-pie-chart' => array('group' => 'sassico-icons'),
					'icon icon-chart-bars' => array('group' => 'sassico-icons'),
					'icon icon-gift1' => array('group' => 'sassico-icons'),
					'icon icon-diamond' => array('group' => 'sassico-icons'),
					'icon icon-dinner' => array('group' => 'sassico-icons'),
					'icon icon-coffee-cup' => array('group' => 'sassico-icons'),
					'icon icon-leaf' => array('group' => 'sassico-icons'),
					'icon icon-paw' => array('group' => 'sassico-icons'),
					'icon icon-rocket' => array('group' => 'sassico-icons'),
					'icon icon-briefcase1' => array('group' => 'sassico-icons'),
					'icon icon-bus' => array('group' => 'sassico-icons'),
					'icon icon-car' => array('group' => 'sassico-icons'),
					'icon icon-train' => array('group' => 'sassico-icons'),
					'icon icon-bicycle' => array('group' => 'sassico-icons'),
					'icon icon-wheelchair' => array('group' => 'sassico-icons'),
					'icon icon-select' => array('group' => 'sassico-icons'),
					'icon icon-earth' => array('group' => 'sassico-icons'),
					'icon icon-smile' => array('group' => 'sassico-icons'),
					'icon icon-sad1' => array('group' => 'sassico-icons'),
					'icon icon-neutral' => array('group' => 'sassico-icons'),
					'icon icon-mustache' => array('group' => 'sassico-icons'),
					'icon icon-alarm' => array('group' => 'sassico-icons'),
					'icon icon-bullhorn' => array('group' => 'sassico-icons'),
					'icon icon-volume-high' => array('group' => 'sassico-icons'),
					'icon icon-volume-medium' => array('group' => 'sassico-icons'),
					'icon icon-volume-low' => array('group' => 'sassico-icons'),
					'icon icon-volume' => array('group' => 'sassico-icons'),
					'icon icon-mic1' => array('group' => 'sassico-icons'),
					'icon icon-hourglass1' => array('group' => 'sassico-icons'),
					'icon icon-undo' => array('group' => 'sassico-icons'),
					'icon icon-redo' => array('group' => 'sassico-icons'),
					'icon icon-sync' => array('group' => 'sassico-icons'),
					'icon icon-history' => array('group' => 'sassico-icons'),
					'icon icon-clock1' => array('group' => 'sassico-icons'),
					'icon icon-download1' => array('group' => 'sassico-icons'),
					'icon icon-upload1' => array('group' => 'sassico-icons'),
					'icon icon-enter-down' => array('group' => 'sassico-icons'),
					'icon icon-exit-up' => array('group' => 'sassico-icons'),
					'icon icon-bug' => array('group' => 'sassico-icons'),
					'icon icon-code' => array('group' => 'sassico-icons'),
					'icon icon-link' => array('group' => 'sassico-icons'),
					'icon icon-unlink' => array('group' => 'sassico-icons'),
					'icon icon-thumbs-up' => array('group' => 'sassico-icons'),
					'icon icon-thumbs-down' => array('group' => 'sassico-icons'),
					'icon icon-magnifier' => array('group' => 'sassico-icons'),
					'icon icon-cross' => array('group' => 'sassico-icons'),
					'icon icon-menu' => array('group' => 'sassico-icons'),
					'icon icon-list' => array('group' => 'sassico-icons'),
					'icon icon-chevron-up' => array('group' => 'sassico-icons'),
					'icon icon-chevron-down' => array('group' => 'sassico-icons'),
					'icon icon-chevron-left' => array('group' => 'sassico-icons'),
					'icon icon-chevron-right' => array('group' => 'sassico-icons'),
					'icon icon-arrow-up' => array('group' => 'sassico-icons'),
					'icon icon-arrow-down' => array('group' => 'sassico-icons'),
					'icon icon-arrow-left' => array('group' => 'sassico-icons'),
					'icon icon-arrow-right' => array('group' => 'sassico-icons'),
					'icon icon-move' => array('group' => 'sassico-icons'),
					'icon icon-warning' => array('group' => 'sassico-icons'),
					'icon icon-question-circle' => array('group' => 'sassico-icons'),
					'icon icon-menu-circle' => array('group' => 'sassico-icons'),
					'icon icon-checkmark-circle' => array('group' => 'sassico-icons'),
					'icon icon-cross-circle' => array('group' => 'sassico-icons'),
					'icon icon-plus-circle' => array('group' => 'sassico-icons'),
					'icon icon-circle-minus' => array('group' => 'sassico-icons'),
					'icon icon-arrow-up-circle' => array('group' => 'sassico-icons'),
					'icon icon-arrow-down-circle' => array('group' => 'sassico-icons'),
					'icon icon-arrow-left-circle' => array('group' => 'sassico-icons'),
					'icon icon-arrow-right-circle' => array('group' => 'sassico-icons'),
					'icon icon-chevron-up-circle' => array('group' => 'sassico-icons'),
					'icon icon-chevron-down-circle' => array('group' => 'sassico-icons'),
					'icon icon-chevron-left-circle' => array('group' => 'sassico-icons'),
					'icon icon-chevron-right-circle' => array('group' => 'sassico-icons'),
					'icon icon-crop' => array('group' => 'sassico-icons'),
					'icon icon-frame-expand' => array('group' => 'sassico-icons'),
					'icon icon-frame-contract' => array('group' => 'sassico-icons'),
					'icon icon-layers1' => array('group' => 'sassico-icons'),
					'icon icon-funnel' => array('group' => 'sassico-icons'),
					'icon icon-text-format' => array('group' => 'sassico-icons'),
					'icon icon-text-size' => array('group' => 'sassico-icons'),
					'icon icon-bold' => array('group' => 'sassico-icons'),
					'icon icon-italic' => array('group' => 'sassico-icons'),
					'icon icon-underline' => array('group' => 'sassico-icons'),
					'icon icon-strikethrough' => array('group' => 'sassico-icons'),
					'icon icon-highlight' => array('group' => 'sassico-icons'),
					'icon icon-text-align-left' => array('group' => 'sassico-icons'),
					'icon icon-text-align-center' => array('group' => 'sassico-icons'),
					'icon icon-text-align-right' => array('group' => 'sassico-icons'),
					'icon icon-text-align-justify' => array('group' => 'sassico-icons'),
					'icon icon-line-spacing' => array('group' => 'sassico-icons'),
					'icon icon-indent-increase' => array('group' => 'sassico-icons'),
					'icon icon-indent-decrease' => array('group' => 'sassico-icons'),
					'icon icon-page-break' => array('group' => 'sassico-icons'),
					'icon icon-hand' => array('group' => 'sassico-icons'),
					'icon icon-pointer-up' => array('group' => 'sassico-icons'),
					'icon icon-pointer-right' => array('group' => 'sassico-icons'),
					'icon icon-pointer-down' => array('group' => 'sassico-icons'),
					'icon icon-pointer-left' => array('group' => 'sassico-icons'),
					'icon icon-vplay' => array('group' => 'sassico-icons'),
					'icon icon-newsletter' => array('group' => 'sassico-icons'),
					'icon icon-coins-2' => array('group' => 'sassico-icons'),
					'icon icon-commerce-2' => array('group' => 'sassico-icons'),
					'icon icon-monitor' => array('group' => 'sassico-icons'),
					'icon icon-graphic-3' => array('group' => 'sassico-icons'),
					'icon icon-business' => array('group' => 'sassico-icons'),
					'icon icon-graphic-2' => array('group' => 'sassico-icons'),
					'icon icon-commerce-1' => array('group' => 'sassico-icons'),
					'icon icon-hammer' => array('group' => 'sassico-icons'),
					'icon icon-graphic-1' => array('group' => 'sassico-icons'),
					'icon icon-graphic' => array('group' => 'sassico-icons'),
					'icon icon-justice-1' => array('group' => 'sassico-icons'),
					'icon icon-line' => array('group' => 'sassico-icons'),
					'icon icon-money-3' => array('group' => 'sassico-icons'),
					'icon icon-chart' => array('group' => 'sassico-icons'),
					'icon icon-commerce' => array('group' => 'sassico-icons'),
					'icon icon-agenda' => array('group' => 'sassico-icons'),
					'icon icon-money-2' => array('group' => 'sassico-icons'),
					'icon icon-justice' => array('group' => 'sassico-icons'),
					'icon icon-money-1' => array('group' => 'sassico-icons'),
					'icon icon-money' => array('group' => 'sassico-icons'),
					'icon icon-technology' => array('group' => 'sassico-icons'),
					'icon icon-coins-1' => array('group' => 'sassico-icons'),
					'icon icon-coins' => array('group' => 'sassico-icons'),
					'icon icon-left-arrow' => array('group' => 'sassico-icons'),
					'icon icon-bank' => array('group' => 'sassico-icons'),
					'icon icon-calculator' => array('group' => 'sassico-icons'),
					'icon icon-chart1' => array('group' => 'sassico-icons'),
					'icon icon-chart2' => array('group' => 'sassico-icons'),
					'icon icon-checked' => array('group' => 'sassico-icons'),
					'icon icon-clock2' => array('group' => 'sassico-icons'),
					'icon icon-comment' => array('group' => 'sassico-icons'),
					'icon icon-comments' => array('group' => 'sassico-icons'),
					'icon icon-consult' => array('group' => 'sassico-icons'),
					'icon icon-consut2' => array('group' => 'sassico-icons'),
					'icon icon-deal' => array('group' => 'sassico-icons'),
					'icon icon-download2' => array('group' => 'sassico-icons'),
					'icon icon-envelope2' => array('group' => 'sassico-icons'),
					'icon icon-euro' => array('group' => 'sassico-icons'),
					'icon icon-folder' => array('group' => 'sassico-icons'),
					'icon icon-invest' => array('group' => 'sassico-icons'),
					'icon icon-loan' => array('group' => 'sassico-icons'),
					'icon icon-map-marker1' => array('group' => 'sassico-icons'),
					'icon icon-mutual-fund' => array('group' => 'sassico-icons'),
					'icon icon-percent' => array('group' => 'sassico-icons'),
					'icon icon-phone2' => array('group' => 'sassico-icons'),
					'icon icon-pie-chart1' => array('group' => 'sassico-icons'),
					'icon icon-play' => array('group' => 'sassico-icons'),
					'icon icon-left-arrow2' => array('group' => 'sassico-icons'),
					'icon icon-savings' => array('group' => 'sassico-icons'),
					'icon icon-search1' => array('group' => 'sassico-icons'),
					'icon icon-tag1' => array('group' => 'sassico-icons'),
					'icon icon-tags' => array('group' => 'sassico-icons'),
					'icon icon-tax' => array('group' => 'sassico-icons'),
					'icon icon-quote1' => array('group' => 'sassico-icons'),
					'icon icon-right-arrow2' => array('group' => 'sassico-icons'),
