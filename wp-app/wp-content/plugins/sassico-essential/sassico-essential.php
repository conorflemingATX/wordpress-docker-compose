<?php
/*
* Plugin Name: SASSICO Essentials
* License - GNU/GPL V2 or Later
* Description: This is a required plugin for SASSICO theme.
* Version: 1.0
* text domain: sassico-essential
*/
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
// Add language
add_action( 'init', 'sassico_language_load' );
function sassico_language_load(){
    $plugin_dir = basename(dirname(__FILE__))."/languages/";
    load_plugin_textdomain( 'sassico-essential', false, $plugin_dir );
}

// main class
class Sassico_Essentials_Includes {
      // auto load
    // ----------------------------------------------------------------------------------------
	...
	public static function include_widget( $widget_dir ) {
		...
		register_widget( 'SASSICO_' . self::dirname_to_classname( $widget_dir ) );
	}
...
Sassico_Essentials_Includes::init();
