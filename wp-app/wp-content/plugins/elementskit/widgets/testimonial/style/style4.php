			...
			<div class="elementskit-commentor-content">
				<?php if(isset($ekit_testimonial_wartermark_enable) && $ekit_testimonial_wartermark_enable == 'yes'):?>
					...
					<?php
						...
						if($is_new || $migrated) : ?>
							<i class="<?php echo esc_attr($settings['ekit_testimonial_wartermarks']['value']); ?> <?php if ($ekit_testimonial_wartermark_custom_position == 'yes') : ?> ekit_watermark_icon_custom_position <?php endif; ?>"></i>
						<?php else : ?>
							<i class="<?php echo esc_attr( $settings['ekit_testimonial_wartermark'] ); ?> <?php if ($ekit_testimonial_wartermark_custom_position == 'yes') : ?> ekit_watermark_icon_custom_position <?php endif; ?>"></i>
						<?php endif;
					?>
