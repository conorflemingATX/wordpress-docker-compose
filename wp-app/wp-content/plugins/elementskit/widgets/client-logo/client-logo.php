...
class Elementskit_Widget_Client_Logo extends Widget_Base {
    ...
    protected function render_raw( ) {
        ...
        $this->add_render_attribute( 'wrapper', 'data-left_icon', ($is_new || $migrated) ? $settings['ekit_client_logo_left_arrow_icon']['value'] : $settings['ekit_client_logo_left_arrow']);
        ...
        $this->add_render_attribute( 'wrapper', 'data-right_icon', ($is_new || $migrated) ? $settings['ekit_client_logo_right_arrow_icon']['value'] : $settings['ekit_client_logo_right_arrow']);
