    ...
    protected function render_raw( ) {
        ...
        <div class="elementskit-image-accordion-wraper">
            <?php foreach ( $ekit_img_accordion_items as $item ):
                ...
                $icon = ( $is_new || $migrated ) ? '<i class="'. esc_attr($item['ekit_img_accordion_title_icons']['value']) .'" aria-hidden="true"></i>' : '<i class="'. esc_attr($item['ekit_img_accordion_title_icon']) .'" aria-hidden="true"></i>';
            ?>
            <div href="#" class="elementskit-single-image-accordion <?php echo \ElementsKit\Utils::render(($item['ekit_img_accordion_active'] == 'yes') ? 'active' : '') ; ?>" style="background-image: url(<?php echo esc_url($item['ekit_img_accordion_bg']['url']); ?>)">
                <div class="elementskit-accordion-content">
                   <?php if($item['ekit_img_accordion_enable_pupup'] == 'yes' || $item['ekit_img_accordion_enable_project_link'] == 'yes') {
                       ...
                       $pup_up_icon = ( $is_new || $migrated ) ?  esc_attr($item['ekit_img_accordion_pup_up_icons']['value']) . ' icon-outline circle'  : $item['ekit_img_accordion_pup_up_icon'] . ' icon-outline circle';
                        ...
                        $project_icon = ( $is_new || $migrated ) ?  esc_attr($item['ekit_img_accordion_project_link_icons']['value']) . ' icon-outline circle fd' : $item['ekit_img_accordion_project_link_icon'] . ' icon-outline circle fd';
